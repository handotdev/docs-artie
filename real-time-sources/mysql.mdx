...
description: In this section, we will go over how to gather your credentials and prepare your MySQL to start providing CDC logs.
---
...
* [amazon-rds-or-aurora.md](/real-time-sources/mysql/amazon-rds-or-aurora)
