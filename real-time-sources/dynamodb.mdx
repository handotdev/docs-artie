---
title: DynamoDB
description: In this page, we will go over how to retrieve all the necessary settings so we can start to replicate from DynamoDB by leveraging DynamoDB streams.
---
...
<Frame><img src="/assets/image (2) (1) (1).png" alt=""/></Frame>
