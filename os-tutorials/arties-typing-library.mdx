---
title: Artie's typing library
description: Curious how Artie's typing library works? You've come to the right place! Here, we will discuss how Artie's internal typing library works and how we ensure source-data integrity.
---
...
<Frame captions="JSON object preservation in Snowflake example"><img src="/assets/image (8).png" alt="" /></Frame>
...
<Frame captions="Normal array"><img src="/assets/image (32).png" alt="" /></Frame>

<Frame captions="Array with nested objects"><img src="/assets/image (12).png" alt="" /></Frame>
