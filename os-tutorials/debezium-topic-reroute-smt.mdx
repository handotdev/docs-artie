---
title: Debezium Topic Reroute SMT
description: In this tutorial, we will go over how to set up Debezium Topic Routing SMTs and how this works with Transfer.
---
